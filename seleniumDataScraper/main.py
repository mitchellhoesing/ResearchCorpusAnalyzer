...
"download.default_directory": r"C:\Users\hoesi\PycharmProjects\CorpusAnalyzer\seleniumDataScraper\papers", #Change default directory for downloads
...
raw = parser.from_file('./proceedings/chi2019-papers/1proc/paper004.pdf')
# print(raw['content'])
f = open("test2019.txt", "w")
